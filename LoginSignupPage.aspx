    ...
    <form id="form1" class="login-form" runat="server">
        ...
        <div class="login-container">
            ...
            <div class="login-input">
                ...
                <asp:TextBox ID="PasswordHash" runat="server" TextMode="Password" CssClass="login-input" style="margin-bottom: 30px; width: 90%; height: 20px; background-color: #E2E2E2; border: none; border-radius: 10px;" />
            </div>
